...
namespace CLARK_INFINITI_UI___TAM_SUNTER_AGV
{
    public partial class Form1 : Form
    {
        ...
        public long jobId, readPower, cntTimer = 0, missionId , jobId1, jobId2,jobNumber,lastjob;
        ...
        public bool line1Click = false, line2Click = false, testState=false, cancelCall=false,forceCancel = false;
        ...
        public string jobStatus, status2, missionName,missionStatus,lastStatus;
            ...
            try
            {
                ...
                if (data.errMark == "OK")
                {
                    ...
                    for (int j = 0; j < data.msg.Count; j++)
                    {
                        ...
                        else if (jobStatus == "放弃" && missionId == 50) { jobStatus = "HOLD"; }
                        else if (jobStatus == "放弃" && missionId == 51) { jobStatus = "HOLD"; }
                    ...
                    lastjob = data.msg[0][0];
                    lastStatus = data.msg[0][10];
                    Console.WriteLine("293 Btn1: {0} - cnt1: {1} - jobF1: {2} - Job: {3} - sJob: {4} ", lastCall, cntCall1, lastStatus, data.msg[1][0], saveJobNumber1);
                    Console.WriteLine("294 Btn1: {0} - cnt2: {1} - jobF2: {2} - Job: {3} - sJob: {4} ", data.msg[1][1], cntCall2, lastStatus, data.msg[1][0], saveJobNumber2);
                    //Console.WriteLine("");
                    if (line1Click == true && cntCall1 != 0 && data.msg[1][0] == saveJobNumber1 && (lastStatus == "正常结束") && (dataRfid ==1 || dataRfid ==0))
                    {
                        jobFinish = true;
                    ...
                    if (line2Click == true && cntCall2 != 0 &&  data.msg[1][0] == saveJobNumber2 && (lastStatus == "正常结束") && (dataRfid == 1 || dataRfid == 0))
                    {
                        jobFinish2 = true;
                ...
                if (data.errMark == "OK")
                {
                    ...
                    for (int i = 0; i < data.msg.Count; i++)
                    {
                        ...
                        if (readAddress == agvAddress && readType == "车")
                        {
                            ...
                            else if (dataRute == 101 && dataRfid != 9 && cntCall1 ==2)
                            {
                            ...
                            else if (dataRute == 101 && dataRfid == 9 && cntCall1 == 2)
                    {
                            ...
                            else if (dataRfid ==11 && cntCall1 == 2)
                            {
                                btnStation1.ButtonText = "EMPTY POST";
                                btnStation1.ActiveFillColor = Color.Orange;
                                btnStation1.IdleFillColor = Color.Orange;
                            }
                            else if ((dataRute == 20) && (dataRfid == 17 || dataRfid == 10) && cntCall1 == 2)
                            {
                                btnStation1.ButtonText = "GO HOME";
                                btnStation1.ActiveFillColor = Color.Orange;
                                btnStation1.IdleFillColor = Color.Orange;
                            }
                            else if (dataRute==20 && dataRfid ==1 && cntCall1 ==0)
                            {
                                btnStation1.ActiveFillColor = Color.LimeGreen;
                                btnStation1.IdleFillColor = Color.LimeGreen;
                                btnStation1.ButtonText = "LINE 1";
                            }
                            //else if (dataRute == 20 && dataRfid == 1)
                            //{
                            //    btnStation1.ActiveFillColor = Color.LimeGreen;
                            //    btnStation1.IdleFillColor = Color.LimeGreen;
                            //    btnStation1.ButtonText = "LINE 1";
                            ...
                            else if (dataRute == 102 && dataRfid != 20 && cntCall2 ==2 )
                            {
                            ...
                            else if (dataRute == 22 && cntCall2 == 2)
                            {
                                btnStation2.ButtonText = "GO TO EMPTY";
                                btnStation2.ActiveFillColor = Color.Orange;
                                btnStation2.IdleFillColor = Color.Orange;
                            }
                            else if (dataRfid==11 && cntCall2 == 2 )
                            {
                            ...
                            else if (dataRute == 20 && cntCall2 ==0)
                            {
                                btnStation2.ActiveFillColor = Color.LimeGreen;
                                btnStation2.IdleFillColor = Color.LimeGreen;
                                btnStation2.ButtonText = "LINE 2";
                            }
                            else { Console.WriteLine("cok 2"); }
                    ...
                    || (line1Click == true && cntCall1 == 1 && testState == false && dataRfid ==0) )
                {
                    ...
                    Console.WriteLine("dataCalling.errMark : {0}", dataCalling.errMark);
                ...
                if (line2Click == true && cntCall2 == 1 && testState == false && jobFinish2 == true && (lastDelivery == "正常结束" || lastDelivery == "放弃") && lastDelivery != "执行"
                    || (line2Click == true && cntCall2 == 1 && testState == false && dataRfid == 0))
                    {
                ...
                Console.WriteLine("");
                if (forceCancel == true && lastStatus == "执行")          //RUNNING -> 执行
                {
                    jobNumber = jobNumber + 9;
                    Disini("586", lastjob.ToString(), lastStatus);
                    string cancelJobid = tbCancelCall.Text;
                    string cancelApi = "missionC.netMissionCancel(" + lastjob + ")";
                ...
                if ((cancelCall == true && tbCancelCall.Text != "" && tbCancelCall.Text != "0000"))
                {
                    ...
                    {
                        cancelCall = false; tbCancelCall.Clear(); forceCancel = false;
                    }
                ...
                else if (cancelCall == true && tbCancelCall.Text == "0000")
                {
                    cntCall1 = 0;cntCall2 = 0;
                ...
                else {   cancelCall = false; cntCancel = 0; forceCancel = false; }
                callAPI();
